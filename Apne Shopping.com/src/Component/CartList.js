  ...
  return (
    ...
    <div style={{backgroundColor:'white'}}>
      <div style={{ borderBottom: '2px solid #ccc', marginBottom: '20px', paddingBottom: '10px' }}>
        ...
        <FaWallet onClick={Wallet} style={{ fontSize: '40px', color: '#237be4f5', cursor: 'pointer', float:'right',marginTop:'20px',marginRight:'30px'  }} />
            ...
            <li key={item.id} style={{ borderBottom: '1px solid #ccc', marginBottom: '10px', paddingBottom: '10px', display: 'flex', alignItems: 'center' }}>
              ...
              <div style={{ marginLeft: '20px', flex: '1' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', marginTop: '10px' }}>
                  ...
                  <button onClick={() => removeFromCart(item.id)} style={{ marginRight: '5px', width:'100px' }}>Remove</button>
      ...
      <div style={{ marginTop: '20px', width:'100%', backgroundColor:'whitesmoke',display:'flex' }}>
